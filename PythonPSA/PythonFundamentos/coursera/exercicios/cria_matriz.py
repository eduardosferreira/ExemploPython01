...
def fnc_matriz(p_nr_linhas=0,p_nr_colunas=0,p_nr_valor=0):
    # criacao variaveis
...
def fnc_leitura_matriz():
    ...
    if len(ob_matriz) > 0:    
        print("[")
        for nr_linha in range(len(ob_matriz)):
            if len(ob_matriz[nr_linha]) > 0:        
                print(" " + "[",end='')
                for nr_coluna in range(len(ob_matriz[nr_linha])):
                    if nr_coluna == len(ob_matriz[nr_linha])-1:
                        print(str(ob_matriz[nr_linha][nr_coluna]),end='')
                    else:
                        print(str(ob_matriz[nr_linha][nr_coluna]),end=',')
                print("]")
        print("]") 
